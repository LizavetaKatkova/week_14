...
const myInformation = ['Liza', 12, 11, 'scorpio'];
...
let otherRussianCities = ['Санкт-Петербруг', 'Москва', 'Екатеринбург'];
